...
struct ImageSliderViewVortexTab90: View {
    
    // 1
    private let images = ["VortexTab90", "VortexTab90", "VortexTab90"]
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewVortexTab90()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура беспроводная Vortex Tab 90")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: VortexTab90Description(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: VortexTab90Specs(), label: {
...
struct VortexTab90Description: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Помните, мы писали, что у Vortex свой взгляд на компоновку клавиатур? Познакомьтесь — полноразмерная Tab 90.
            Как всегда компактно, как всегда программируемо и, как всегда, всё на высшем уровне. Идеальный вариант для любых задач как на работе, так и дома.

            P.S. Да, она беспроводная и очень долго работает от двух AAA.
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct VortexTab90_Previews: PreviewProvider {
