...
struct ImageSliderViewDuckyOne2TKLSkyline: View {
    
    // 1
    private let images = ["DuckyOne2TKLSkyline", "DuckyOne2TKLSkyline", "DuckyOne2TKLSkyline"]
...
struct DuckyOne2TKLSkyline: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewDuckyOne2TKLSkyline()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Ducky One 2 TKL Skyline")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: DuckyOne2TKLSkylineDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: DuckyOne2TKLSkylineSpecs(), label: {
...
struct DuckyOne2TKLSkylineDescription: View {
    
    var body: some View {

        ScrollView{
        Text("Вы знаете разницу между словами Skyline и Horizon? Если напишите её в примечании к заказу, то получите скидку в 5%. Владельцам Nissan Skyline дополнительная скидка при предъявлении техпаспорта. Десять кейкапов прекрасного небесного цвета в комплекте к каждой клавиатуре.")
            .font(.title3)
            .padding()
            Spacer()
...
struct DuckyOne2TKLSkylineSpecs: View {
...
struct DuckyOne2TKLSkyline_Previews: PreviewProvider {
