...
struct ImageSliderViewDuckyOne3TKLDaybreak: View {
    
    // 1
    private let images = ["DuckyOne3TKLDaybreak", "DuckyOne3TKLDaybreak", "DuckyOne3TKLDaybreak"]
...
struct DuckyOne3TKLDaybreak: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewDuckyOne3TKLDaybreak()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Ducky One 3 TKL Daybreak")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: DuckyOne3TKLDaybreakDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: DuckyOne3TKLDaybreakSpecs(), label: {
...
struct DuckyOne3TKLDaybreakDescription: View {
    
    var body: some View {

        ScrollView{
        Text("Вы встаёте с рассветом? Или ложитесь после? Или может быть вообще живёте по стандартному галактическому времени? One 3 Daybreak рада вам в любое время дня и ночи, а не только на рассвете. Тем не менее, мы хотим напомнить, если цвет клавиатуры проигрывает по насыщенности синякам под вашими глазами, то стоит сделать перерыв, хорошенько отдохнуть и уже на свежую голову выбирать свичи для своей клавиатуры.")
            .font(.title3)
            .padding()
            Spacer()
...
struct DuckyOne3TKLDaybreakSpecs: View {
...
struct DuckyOne3TKLDaybreak_Previews: PreviewProvider {
    static var previews: some View {
        DuckyOne3TKLDaybreak()
    }
}
