...
struct ImageSliderViewDuckyOne2TKLTuxedo: View {
    
    // 1
    private let images = ["DuckyOne2TKLTuxedo", "DuckyOne2TKLTuxedo", "DuckyOne2TKLTuxedo"]
...
struct DuckyOne2TKLTuxedo: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewDuckyOne2TKLTuxedo()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Ducky One 2 TKL Tuxedo")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: DuckyOne2TKLTuxedoDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: DuckyOne2TKLTuxedoSpecs(), label: {
...
struct DuckyOne2TKLTuxedoDescription: View {
    
    var body: some View {

        ScrollView{
        Text("Название этой модели правильно произносится как \"так-си-до\". С непривычки можно подумать, что вам нужно куда-то уехать, однако это переводится как смокинг. И тут уже впору задуматься о том, что курить вредно и пора давно бросать, но это всего-лишь такой костюм для торжественных мероприятий. Пожалуй, более точного описания для клавиатуры и не придумаешь, разве что добавим, что она без нампада, хотя где вы смокинг с нампадом видели?")
            .font(.title3)
            .padding()
            Spacer()
...
struct DuckyOne2TKLTuxedoSpecs: View {
...
struct DuckyOne2TKLTuxedo_Previews: PreviewProvider {
