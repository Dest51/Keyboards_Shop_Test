...
struct ImageSliderViewDuckyOne2TKLHorizon: View {
    
    // 1
    private let images = ["DuckyOne2TKLHorizon", "DuckyOne2TKLHorizon", "DuckyOne2TKLHorizon"]
...
struct DuckyOne2TKLHorizon: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewDuckyOne2TKLHorizon()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Ducky One 2 TKL Horizon")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: DuckyOne2TKLHorizonDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: DuckyOne2TKLHorizonSpecs(), label: {
...
struct DuckyOne2TKLHorizonDescription: View {
    
    var body: some View {

        ScrollView{
        Text("Говорят, наблюдение за горизонтом, благоприятно сказывается на тонусе ваших глазных мышц. Мы не проверяли. Зато мы точно знаем, что наблюдение за Ducky One 2 TKL Horizon на вашем рабочем столе повышает продуктивность и желание стучать по клавишам, а десять сменных кейкапов неслучайного цвета в комплекте есть, вы уж не сомневайтесь.")
            .font(.title3)
            .padding()
            Spacer()
...
struct DuckyOne2TKLHorizonSpecs: View {
...
struct DuckyOne2TKLHorizon_Previews: PreviewProvider {
