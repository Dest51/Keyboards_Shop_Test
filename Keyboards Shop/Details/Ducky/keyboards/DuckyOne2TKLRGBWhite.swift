...
struct ImageSliderViewDuckyOne2TKLRGBWhite: View {
    
    // 1
    private let images = ["DuckyOne2TKLRGBWhite", "DuckyOne2TKLRGBWhite", "DuckyOne2TKLRGBWhite"]
...
struct DuckyOne2TKLRGBWhite: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewDuckyOne2TKLRGBWhite()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Ducky One 2 TKL RGB White")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: DuckyOne2TKLRGBWhiteDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: DuckyOne2TKLRGBWhiteSpecs(), label: {
...
struct DuckyOne2TKLRGBWhiteDescription: View {
    
    var body: some View {

        ScrollView{
        Text("Мы перестали увольнять копирайтеров за спотыкания при попытке описать модели One 2 TKL RGB. Да и какие могут быть претензии к человеку, который теряет дар речи, когда видит её в белом цвете? Очень аккуратная, красивая и вместе с этим очень прилично упакованная клавиатура. Посудите сами PBT doubleshot с бэклитом есть, RGB есть, USB Type-C есть, Ducky Macro есть, поддержка софта для настройки подсветки, тоже есть! Что ещё нужно? Десять цветных капов и тематический пробел? Так они тоже есть, куда же без них?")
            .font(.title3)
            .padding()
            Spacer()
...
struct DuckyOne2TKLRGBWhiteSpecs: View {
...
struct DuckyOne2TKLRGBWhite_Previews: PreviewProvider {
    static var previews: some View {
        DuckyOne2TKLRGBWhite()
    }
}
