//
//  LeopoldFC980MDarkYellowPD.swift
//  Keyboards Shop
//
...
struct ImageSliderViewLeopoldFC980MDarkYellowPD: View {
    
    // 1
    private let images = ["LeopoldFC980MDarkYellowPD", "LeopoldFC980MDarkYellowPD", "LeopoldFC980MDarkYellowPD"]
...
struct LeopoldFC980MDarkYellowPD: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewLeopoldFC980MDarkYellowPD()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Leopold FC980M Dark Yellow PD")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: LeopoldFC980MDarkYellowPDDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: LeopoldFC980MDarkYellowPDSpecs(), label: {
...
struct LeopoldFC980MDarkYellowPDDescription: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Новая модель в очень трудолюбивой расцветке. Не рекомендуем приносить её в офис, коллеги будут виться вокруг стола, словно им мёдом намазано, а потом прожужжат всем уши про то, какая у вас классная клавиатура. Народное средство от назойливых коллег — три раза левой рукой нажать энтер, кинуть в них ссылкой на наш сайт и громко сказать: "иди-иди да себе клавиатуру нормальную купи"
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct LeopoldFC980MDarkYellowPDSpecs: View {
...
struct LeopoldFC980MDarkYellowPD_Previews: PreviewProvider {
    static var previews: some View {
        LeopoldFC980MDarkYellowPD()
    }
}
