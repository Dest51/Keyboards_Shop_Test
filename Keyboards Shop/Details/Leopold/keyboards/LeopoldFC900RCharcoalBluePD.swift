//
//  LeopoldFC900RCharcoalBluePD.swift
//  Keyboards Shop
//
...
struct ImageSliderViewLeopoldFC900RCharcoalBluePD: View {
    
    // 1
    private let images = ["LeopoldFC900RCharcoalBluePD", "LeopoldFC900RCharcoalBluePD", "LeopoldFC900RCharcoalBluePD"]
...
struct LeopoldFC900RCharcoalBluePD: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewLeopoldFC900RCharcoalBluePD()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура беспроводная Leopold FC900R Charcoal Blue PD")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: LeopoldFC900RCharcoalBluePDDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: LeopoldFC900RCharcoalBluePDSpecs(), label: {
...
struct LeopoldFC900RCharcoalBluePDDescription: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Вам знакомо это ощущение перед грозой, когда небо затянуто тучами, а воздух как будто пропитан электричеством? Всё вокруг на мгновение замирает в ожидании самой яркой вспышки, которая даст отмашку и капли ринутся вниз к земле.
            Leopold удалось поймать этот момент и воплотить его в FC900R Charcoal Blue PD. Сочетание получилось настолько энергичным, что от неё даже немного пахнет озоном.
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct LeopoldFC900RCharcoalBluePDSpecs: View {
...
struct LeopoldFC900RCharcoalBluePD_Previews: PreviewProvider {
    static var previews: some View {
        LeopoldFC900RCharcoalBluePD()
    }
}
