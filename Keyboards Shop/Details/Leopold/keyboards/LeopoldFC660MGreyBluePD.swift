...
struct ImageSliderViewLeopoldFC660MGreyBluePD: View {
    
    // 1
    private let images = ["LeopoldFC660MGreyBluePD", "LeopoldFC660MGreyBluePD", "LeopoldFC660MGreyBluePD"]
...
struct LeopoldFC660MGreyBluePD: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewLeopoldFC660MGreyBluePD()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Leopold FC660M Grey Blue PD")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: LeopoldFC660MGreyBluePDDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: LeopoldFC660MGreyBluePDSpecs(), label: {
...
struct LeopoldFC660MGreyBluePDDescription: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Фирменная расцветка Leopold. Прекрасна, как брюнетка с серо-голубыми глазами. Но в отличии от брюнетки, FC750R OE Grey Blue никогда не будет против, если Вы заведёте ещё одну такую же на работе.
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct LeopoldFC660MGreyBluePDSpecs: View {
...
struct LeopoldFC660MGreyBluePD_Previews: PreviewProvider {
    static var previews: some View {
        LeopoldFC660MGreyBluePD()
    }
}
