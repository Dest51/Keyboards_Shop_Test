//
//  LeopoldFC750RGrayPurplePD.swift
//  Keyboards Shop
//
...
struct ImageSliderViewLeopoldFC750RGrayPurplePD: View {
    
    // 1
    private let images = ["LeopoldFC750RGrayPurplePD", "LeopoldFC750RGrayPurplePD", "LeopoldFC750RGrayPurplePD"]
...
struct LeopoldFC750RGrayPurplePD: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewLeopoldFC750RGrayPurplePD()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Leopold FC750R Gray Purple PD")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: LeopoldFC750RGrayPurplePDDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: LeopoldFC750RGrayPurplePDSpecs(), label: {
...
struct LeopoldFC750RGrayPurplePDDescription: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Хотелось бы написать, что при создании FC750R Gray Purple в Leopold вдохновлялись нашим логотипом, но мы не знаем этого наверняка, а спрашивать как-то неудобно. Стоит ли говорить, что удачное сочетание дымчато-серого с пурпурным весьма ей к лицу и внушает оптимизм, спокойствие и уверенность в долгосрочном сотрудничестве. Точно как с нас писали.
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct LeopoldFC750RGrayPurplePDSpecs: View {
...
struct LeopoldFC750RGrayPurplePD_Previews: PreviewProvider {
    static var previews: some View {
        LeopoldFC750RGrayPurplePD()
    }
}
