...
struct ImageSliderViewNiz87Waterproof: View {
    
    // 1
    private let images = ["87Waterproof", "87Waterproof", "87Waterproof"]
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                Text("Клавиатура проводная Niz 87 Waterproof")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: Niz87WaterproofDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: Niz87WaterproofSpecs(), label: {
...
struct Niz87WaterproofDescription: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Любите пить за компьютером и размахивать руками? Машите на здоровье!
            Надоело питаться всухомятку крошками из клавиатуры? Просто добавьте воды и супчик готов!
            Абонемент в бассейн пылится третий месяц? Теперь можно грести работу и не на работе! NiZ Waterproof — греби гребя!
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct Niz87WaterproofSpecs: View {
...
struct _7Waterproof_Previews: PreviewProvider {
