...
struct ImageSliderViewNizMicro82: View {
    
    // 1
    private let images = ["Micro82", "Micro82", "Micro82"]
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewNizMicro82()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Niz Micro82")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: NizMicro82Description(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: NizMicro82Specs(), label: {
...
struct NizMicro82Description: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Micro82 — предложение от NiZ в одном из самых популярных на сегодняшний день размеров клавиатур — 75%. Выделенный F-ряд кому-то придётся по душе, а кому-то нет, дело вкуса. Но вот функционал, качество материалов и ощущения от тайпинга на Topre-подобных переключателях PLUM точно оставят неизгладимое впечатления и все остальные клавиатуры вы уже будете сравнивать с этой.
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct Micro82_Previews: PreviewProvider {
