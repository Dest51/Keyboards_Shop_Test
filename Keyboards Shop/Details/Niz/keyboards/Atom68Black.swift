...
struct ImageSliderViewNizAtom68Black: View {
    
    // 1
    private let images = ["Atom68Black", "Atom68Black", "Atom68Black"]
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewNizAtom68Black()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Niz Atom 68 Black")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: NizAtom68BlackDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: NizAtom68BlackSpecs(), label: {
...
struct NizAtom68BlackDescription: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Согласно статьи в Википедии, А́том (от др.-греч. ἄτομος «неделимый») — частица вещества микроскопических размеров, являющаяся носителем его свойств.
            Так и Atom68 при своих небольших размерах — носитель свойств многих выдающихся клавиатур. Всем хороша! Макросы, поддержка всех ОС, есть в проводном и беспроводном вариантах, а самое главное — электростатические свичи PLUM, печатать на которых сплошное удовольствие.
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct NizAtom68BlackSpecs: View {
...
struct Atom68Black_Previews: PreviewProvider {
