...
struct ImageSliderViewKeychronK8RGBHotswap: View {
    
    // 1
    private let images = ["KeychronK8RGBHotswap", "KeychronK8RGBHotswap", "KeychronK8RGBHotswap"]
...
struct KeychronK8RGBHotswap: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewKeychronK8RGBHotswap()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура беспроводная Keychron K8 RGB Hotswap")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: KeychronK8RGBHotswapDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: KeychronK8RGBHotswapSpecs(), label: {
...
struct KeychronK8RGBHotswapDescription: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Пластиковая версия K8, с горячей заменой переключателей и RGB подсветкой.
...
struct KeychronK8RGBHotswapSpecs: View {
...
struct KeychronK8RGBHotswap_Previews: PreviewProvider {
    static var previews: some View {
        KeychronK8RGBHotswap()
    }
}
