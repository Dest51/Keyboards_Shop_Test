//
//  KeychronK12OpticalAluminumRGBHotswap.swift
//  Keyboards Shop
//
...
struct ImageSliderViewKeychronK12OpticalAluminumRGBHotswap: View {
    
    // 1
    private let images = ["KeychronK12OpticalAluminumRGBHotswap", "KeychronK12OpticalAluminumRGBHotswap", "KeychronK12OpticalAluminumRGBHotswap"]
...
struct KeychronK12OpticalAluminumRGBHotswap: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewKeychronK12OpticalAluminumRGBHotswap()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура беспроводная Keychron K12 Optical Aluminum RGB Hotswap")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: KeychronK12OpticalAluminumRGBHotswapDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: KeychronK12OpticalAluminumRGBHotswapSpecs(), label: {
...
struct KeychronK12OpticalAluminumRGBHotswapDescription: View {
    ...
    var body: some View {
        ...
        Text("""
            ...
            Максимальный вариант модели — RGB с алюминиевой рамкой и горячей заменой переключателей, конкретно в этой модели — оптических.
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct KeychronK12OpticalAluminumRGBHotswapSpecs: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading) {
            ...
            HStack {
                Text("Model: ")
                Spacer()
                Text("K12 Optical Aluminum RGB Hotswap")
            }
            .padding(.vertical)
...
struct KeychronK12OpticalAluminumRGBHotswap_Previews: PreviewProvider {
    static var previews: some View {
        KeychronK12OpticalAluminumRGBHotswap()
    }
}
