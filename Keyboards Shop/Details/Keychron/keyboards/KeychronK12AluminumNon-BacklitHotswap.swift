//
//  KeychronK12AluminumNon-BacklitHotswap.swift
//  Keyboards Shop
//
...
struct ImageSliderViewKeychronK12AluminumNon_BacklitHotswap: View {
    
    // 1
    private let images = ["KeychronK12AluminumNon-BacklitHotswap", "KeychronK12AluminumNon-BacklitHotswap", "KeychronK12AluminumNon-BacklitHotswap"]
...
struct KeychronK12AluminumNon_BacklitHotswap: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewKeychronK12AluminumNon_BacklitHotswap()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура беспроводная Keychron K12 Aluminum Non-backlight Hotswap")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: KeychronK12AluminumNon_BacklitHotswapDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: KeychronK12AluminumNon_BacklitHotswapSpecs(), label: {
...
struct KeychronK12AluminumNon_BacklitHotswapDescription: View {
    ...
    var body: some View {
        ...
        Text("""
            ...
            Модель без подсветки, зато с горячей заменой переключателей и чёрно-белыми капами.
            """)
            .font(.title3)
            .padding()
            Spacer()
...
struct KeychronK12AluminumNon_BacklitHotswapSpecs: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading) {
            ...
            HStack {
                Text("Model: ")
                Spacer()
                Text("K12 Aluminum Non-backlight Hotswap")
            }
            .padding(.vertical)
...
struct KeychronK12AluminumNon_BacklitHotswap_Previews: PreviewProvider {
    static var previews: some View {
        KeychronK12AluminumNon_BacklitHotswap()
    }
}
