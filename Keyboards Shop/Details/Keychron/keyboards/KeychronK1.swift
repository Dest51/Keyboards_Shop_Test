...
struct ImageSliderViewKeychronK1: View {
    
    // 1
    private let images = ["KeychronK1", "KeychronK1", "KeychronK1"]
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewKeychronK1()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура проводная Keychron K1 87 RGB")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: KeychronK1Description(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: KeychronK1Specs(), label: {
...
struct KeychronK1Description: View {
    
    var body: some View {

        ScrollView{
        Text("""
             Не можете расстаться с клавиатурой ноутбука? Все остальные клавиатуры кажутся слишком высокими? Каждый миллиметр высоты ради скоростного набора текста?
             У нас есть решение для Вас! Первая в мире* низкопрофильная клавиатура, созданная специально для профессионалов, работающих в самых востребованных отраслях мира.
             Keychron K1 — присоединяйтесь к лучшим.
...
struct KeychronK1_Previews: PreviewProvider {
