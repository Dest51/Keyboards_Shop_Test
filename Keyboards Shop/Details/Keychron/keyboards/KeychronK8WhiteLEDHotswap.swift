//
//  KeychronK8WhiteLEDHotswap.swift
//  Keyboards Shop
//
...
struct ImageSliderViewKeychronK8WhiteLEDHotswap: View {
    
    // 1
    private let images = ["KeychronK8WhiteLEDHotswap", "KeychronK8WhiteLEDHotswap", "KeychronK8WhiteLEDHotswap"]
...
struct KeychronK8WhiteLEDHotswap: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ImageSliderViewKeychronK8WhiteLEDHotswap()
                    .frame(height: 210)
                    .padding(.top)
                    
                
                Text("Клавиатура беспроводная Keychron K8 White LED Hotswap")
                    .font(.title3)
                    .fontWeight(.semibold)
            ...
            VStack {
                ...
                Divider()
                NavigationLink(destination: KeychronK8WhiteLEDHotswapDescription(), label: {
                    Text("Description")
                    .foregroundColor(Color.primary)
                ...
                Divider()
                NavigationLink(destination: KeychronK8WhiteLEDHotswapSpecs(), label: {
...
struct KeychronK8WhiteLEDHotswapDescription: View {
    
    var body: some View {

        ScrollView{
        Text("""
            Базовая версия K8, с пластиковым корпусом и белой подсветкой.
...
struct KeychronK8WhiteLEDHotswapSpecs: View {
...
struct KeychronK8WhiteLEDHotswap_Previews: PreviewProvider {
    static var previews: some View {
        KeychronK8WhiteLEDHotswap()
    }
}
